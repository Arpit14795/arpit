...
public class SetTopBoxManagementSystemImpl implements
	...
	@Override
	public void calculateBillForEachChannel(List<Channel> list,
			String fileNameUsage) {
		// TODO Auto-generated method stub
		
	}

	@Override
	public List<Channel> sortByHighestHourOfUsage(List<Channel> list,
			String fileNameUsage) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public List<Channel> getByCategory(List<Channel> list,
