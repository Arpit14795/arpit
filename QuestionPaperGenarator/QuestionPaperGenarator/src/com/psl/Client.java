...
public class Client {
	public static void main(String[] args) {
		...
		List<Question> catList=dataManager.getQuestionByCategory(Category.History, queList);
		List<Question> comList=dataManager.getQuestionByComplexity(Complexity.Simple, queList);
			//System.out.println(comList);
		/* Creating template for question Paper */
         dataManager.sortByCategory(queList);
         dataManager.sortByComplexity(queList);
